...
```powershell
python "weakPacket_decoding copy\weak_decoder\os_lora\evaluate_nonuniform_sampling.py" `
  --datasets 0_0_0_10_14_16 `
  --snrs -22 -23 -24 `
  --seeds 42 `
  --max-packets 2 `
  --top-k 8 `
  --output-dir "weakPacket_decoding copy\data\tmp_os_lora_sweep"
```
...
```powershell
python "weakPacket_decoding copy\weak_decoder\os_lora\analyze_nonuniform_matrix.py" `
  --raw-bins 1 61 301 653 900 1023 `
  --bank-kinds fixed basic periodic dither random balanced_random search `
  --random-count 64 `
  --leakage-bins 64 `
  --output-dir "weakPacket_decoding copy\data\tmp_os_lora_matrix"
```
...
```powershell
python "weakPacket_decoding copy\weak_decoder\os_lora\evaluate_pattern_fft_coherence.py" `
  --datasets 0_0_0_10_14_16 `
  --snrs -24 `
  --seeds 42 `
  --max-packets 1 `
  ...
  --random-count 16 `
  --max-patterns 32 `
  --output-dir "weakPacket_decoding copy\data\tmp_pattern_fft_smoke"
```
...
python "weakPacket_decoding copy\weak_decoder\os_lora\evaluate_pattern_fft_coherence.py" `
  ...
  --random-count 16 `
  --max-patterns 32 `
  --output-dir "weakPacket_decoding copy\data\tmp_pattern_fft_sweep"
```
...
python "weakPacket_decoding copy\weak_decoder\os_lora\evaluate_nonuniform_sampling.py" `
  ...
  --output-dir "weakPacket_decoding copy\data\tmp_nonuniform_gcons_seed_sweep_2pkt"
```
...
python "weakPacket_decoding copy\weak_decoder\os_lora\evaluate_nonuniform_sampling.py" `
  ...
  --gate-margin-db 1.0 `
  --gate-switch-ratio 1.1 `
  --output-dir "weakPacket_decoding copy\data\tmp_nonuniform_gcons_default_datasets"
```
...
python "weakPacket_decoding copy\weak_decoder\os_lora\evaluate_nonuniform_sampling.py" `
  ...
  --gate-margin-db 1.5 `
  --gate-switch-ratio 1.1 `
  --output-dir "weakPacket_decoding copy\data\tmp_nonuniform_gated_hybrid_default_2pkt"
```
...
```powershell
python "weakPacket_decoding copy\weak_decoder\os_lora\analyze_empirical_noise_covariance.py" `
  --datasets 0_0_0_10_14_8 0_0_0_10_14_16 0_0_0_10_14_32 `
  ...
  --max-patterns 64 `
  --max-windows 512 `
  --output-dir "weakPacket_decoding copy\data\tmp_empirical_noise_cov_<dataset>_512"
```
