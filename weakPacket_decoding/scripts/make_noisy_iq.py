...
"""
# python .\gr-lora_sdr\weakPacket_decoding\scripts\make_noisy_iq.py -i .\gr-lora_sdr\data\USRP_IQ\0_0_0_10_14_8.bin --samp-rate 500000 --bw 125000 --sync-word 0x34 --noise-power-db 10 15 25 30 --overwrite --preamble-len 8
...
# 直接运行 scripts/make_noisy_iq.py 时，Python 默认只认识 scripts 目录；
