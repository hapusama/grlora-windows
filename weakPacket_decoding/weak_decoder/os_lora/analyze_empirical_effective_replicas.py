#!/usr/bin/env python3
"""Estimate effective replicas with off-packet covariance and target checks."""
...
from weak_decoder.os_lora.analyze_empirical_noise_covariance import (  # noqa: E402
    _active_intervals,
    _corr_stats,
    _effective_replicas_with_noise_power,
...
def _packet_target(
    ...
    for packet in packets:
        ...
        for symbol in packet.get("payload_symbols", []):
            ...
            # Remove the unknown complex symbol amplitude x using the hard target
            # convention a = sqrt(N) * 1.
